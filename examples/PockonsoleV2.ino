...
transMode transType = EXPONENTIAL_EASE; 
...
void animateDMXValues(int chOne, selectionMode selType, int chTwo, String transStartIntensity, String transEndIntensity, transMode transType, int transTime) {
    switch (transType) {
